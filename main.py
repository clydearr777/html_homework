                ...
                <div class="col-4">
                    <div class="card mb-4 rounded-3 shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <button type="button" class="w-100 btn btn-success btn-outline-primary">Купить</button>
                        </div>
                    </div>
...
<p class="d-inline-flex gap-1">
  ...
  <button class="btn btn-info" type="button" data-bs-toggle="collapse" data-bs-target="#collapseExampl" aria-expanded="false" aria-controls="collapseExampl">
    Как купить?
  </button>
    ...
    Как доставить?
      ...
      <button class="btn btn-info" type="button" data-bs-toggle="collapse" data-bs-target="#collapseExamp" aria-expanded="false" aria-controls="collapseExamp">
    Какая гарантия?
  </button>
</p>
<div class="collapse" id="collapseExampl">
  <div class="card card-body">
    Покупка: переводом на карту
  </div>
                    <div class="collapse" id="collapseExample">
  <div class="card card-body">
    Доставка: Никак, сеичас у меня лапки (клешни)
  </div>

                    </div>
                    <div class="collapse" id="collapseExamp">
  <div class="card card-body">
    Гарантия: на все изделия до конца света
  </div>
</div>
...
<script>
    ...
    def do_GET(self):
        ...
        """
        uery_components = parse_qs(urlparse(self.path).query)
